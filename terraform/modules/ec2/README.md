...
Now we have our custom `AMI` in the `us-east-1` region. Next we will use [Terraform](https://www.terraform.io/) to deploy this image together with the required infrastructure.
